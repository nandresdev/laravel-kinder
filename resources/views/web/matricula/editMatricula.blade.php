    ...
    <script>
        function validarCampos(data) {
            ...
            if (typeof data.responseJSON.errors.nombre_apoderado_principal !== 'undefined') {
                ...
                document.getElementById("inputValidacionNombreApoderadoPrincipal").innerHTML = data.responseJSON.errors
            ...
            if (typeof data.responseJSON.errors.telefono_principal !== 'undefined') {
                ...
                document.getElementById("inputValidacionTelefonoApoderadoPrincipal").innerHTML = data.responseJSON.errors
                    .telefono_principal;
            } else {
            ...
            if (typeof data.responseJSON.errors.nombre_apoderado_secundario !== 'undefined') {
                ...
                document.getElementById("inputValidacionNombreApoderadoSecundario").innerHTML = data.responseJSON.errors
            ...
            if (typeof data.responseJSON.errors.telefono_secundario !== 'undefined') {
                ...
                document.getElementById("inputValidacionTelefonoApoderadoSecundario").innerHTML = data.responseJSON.errors
                    .telefono_secundario;
            } else {
